var MediaManager = (function() {
  ...
  var reMinWidth = /\(min\-width:[\s]*([\s]*[0-9\.]+)(px|em)[\s]*\)/
    ...
    // not necessarily the base fonts-size
    , emValueInPixels
    , currentWidth
   ...
   * are the value of the browsers default fonts size, usually 16px
   */
  function getEmValueInPixels() {
    ...
    // 1em is the value of the default fonts size of the browser
