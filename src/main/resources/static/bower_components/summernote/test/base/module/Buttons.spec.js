...
describe('Buttons', () => {
  ...
  describe('fonts family button', () => {
    it('should select the right fonts family name in the dropdown list when it is clicked', (done) => {
  ...
  */
  ...
  describe('fonts family button', () => {
    it('should change fonts family when it is clicked', (done) => {
      var $li = $toolbar.find('.dropdown-fontname a[data-value="Comic Sans MS"]');
      var $span = $toolbar.find('span.note-current-fontname');
      assert.isTrue($li.length === 1);
      assert.isTrue($span.text() !== 'Comic Sans MS');
  ...
  describe('fonts size button', () => {
    it('should update fonts size button value when changing fonts size', (done) => {
